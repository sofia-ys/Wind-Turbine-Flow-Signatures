...
save("./NREL_FXXXXX_5D_000_00025_copy/exportedMat/coordinate_yPlane.mat", ...
        "coordinate_yPlane");
...
for indexCSVHolder = indexOfCSVfileArray
    ...
    save("./NREL_FXXXXX_5D_000_00025_copy/exportedMat/yPlane_" + indexOfCSVfileString + ".mat", ...
        "interporlatedData");
...
%         zLabelz.Position = [-3.1000    1.0    0.3072];
        ...
        if saveFigure == 1
            exportgraphics(FigMaster,"./NREL_FXXXXX_5D_000_00025_copy/exportedPNGFlat/yPlane_" + indexOfCSVfileString + ".png")
