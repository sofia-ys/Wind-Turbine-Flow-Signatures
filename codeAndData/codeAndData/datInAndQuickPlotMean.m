...
if saveMat == 1
    save("./NREL_FXXXXX_5D_000_00025_copy/exportedMatMean/coordinate_yPlaneMean.mat", ...
...
% 
% 
% coordinate_xPlaneMean.yq = yq;
% coordinate_xPlaneMean.zq = zq;
% 
% save("./NREL_FXXXXX_5D_000_00025_copy/exportedCSVMean/coordinate_xPlaneMean.mat", ...
%         "coordinate_xPlaneMean");
...
for indexCSVHolder = indexOfCSVfileArray
    ...
    csvTail = {};
%     csvTail{1} = "./NREL_FXXXXX_5D_000_00025_copy/exportedCSV/yPlane_" + indexOfCSVfileString + ".csv";

    csvTail{1} = "./NREL_FXXXXX_5D_000_00025_copy/exportedCSVMean/yPlane_00D_mean.csv";
    csvTail{2} = "./NREL_FXXXXX_5D_000_00025_copy/exportedCSVMean/xPlane_02D_mean.csv";
    csvTail{3} = "./NREL_FXXXXX_5D_000_00025_copy/exportedCSVMean/xPlane_05D_mean.csv";
    csvTail{4} = "./NREL_FXXXXX_5D_000_00025_copy/exportedCSVMean/xPlane_08D_mean.csv";
...
%             openFaomW{pp, gg} = dataIn{pp, gg}.("U:2");
            ...
            openFaomU{pp, gg} = dataIn{pp, gg}.("UMean:0");
            openFaomV{pp, gg} = dataIn{pp, gg}.("UMean:1");
            openFaomW{pp, gg} = dataIn{pp, gg}.("UMean:2");
    ...
    vq = griddata(openFaomX{pp, indexOfPlane}/D, openFaomZ{pp, indexOfPlane}/D, ...
        openFaomV{pp, indexOfPlane}/V0,xq,zq);
    ...
    if (alwayPlotting == 1 || indexCSVHolder == indexOfCSVfileArray(end))
        ...
        colobar_string = "$\overline{u} / u_{\infty}$";
        ...
        figureSizeSet = [100 500 1550 750];
        FigMaster = figure;
        ...
        for xxx = xplaneIntersted
            ...
            wq = griddata(openFaomY{pp, indexOfPlane}/D, openFaomZ{pp, indexOfPlane}/D, ...
                openFaomW{pp, indexOfPlane}/V0,yq,zq);

            uq = griddata(openFaomY{pp, indexOfPlane}/D, openFaomZ{pp, indexOfPlane}/D, ...
                openFaomU{pp, indexOfPlane}/V0,yq,zq);
...
%         h.FontSize = annotation_font_size;
        ...
        boxLineWidth = 0.8;
        plot3([xmin xmin], [ymin ymin], [zmin zmax], '-k', 'LineWidth', boxLineWidth)
        plot3([xmin xmin], [ymin ymax], [zmax zmax], '-k', 'LineWidth', boxLineWidth)
        plot3([xmin xmax], [ymin ymin], [zmax zmax], '-k', 'LineWidth', boxLineWidth)
        ...
        if saveFigure == 1
            exportgraphics(FigMaster,"./NREL_FXXXXX_5D_000_00025_copy/exportedPNGMean/yPlaneMean3D.png")
